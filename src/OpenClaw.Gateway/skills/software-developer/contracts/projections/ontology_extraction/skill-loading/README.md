...
这个目录演示 `software-developer` 作为 consumer skill 时，如何按约定消费 `ontology_extraction` 生成的 projection 文件。
...
这份文件由 `ontology_extraction` 生成并迁移而来，对应上游基线是：

- `../../../../../ontology_extraction/examples/ready/sample-projection.json`
