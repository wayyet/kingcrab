...
- 只处理 `target_skill: external_config` 且状态为 `ready_to_dispatch` 或 `dirty` 的 todo。
...
- [references/handoff-contract.md](references/handoff-contract.md)：输入、字段映射和 callback 合约
