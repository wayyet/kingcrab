...
namespace OpenClaw.TokenHubSink.Security;
...
/// </list>
/// Mirrors TokenHub.Core.Security.SecretResolver so both ends of the link resolve the shared
/// ingest Bearer the same way; keep behaviour in sync if the upstream implementation changes.
/// </summary>
