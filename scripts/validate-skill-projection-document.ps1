...
$defaultInputPath = Join-Path $repoRoot "src\OpenClaw.Gateway\skills\software-developer\contracts\projections\ontology_extraction\skill-loading\skill-loading.domain-model.projection.json"
