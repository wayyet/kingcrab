...
1. 落第一份 `ontology_extraction` slice。
2. 在 consumer skill 下落第一个任务域。
3. 为这个任务域落第一个可被 runtime 消费的 projection。

如果你只想先把第一条 producer -> consumer -> runtime 的链路打通，这篇文档应该优先于更偏方法论的 [docs/ontology_extraction-slice-to-skill-method.md](docs/ontology_extraction-slice-to-skill-method.md)。
...
- [src/OpenClaw.Gateway/skills/software-developer/contracts/projections/ontology_extraction](src/OpenClaw.Gateway/skills/software-developer/contracts/projections/ontology_extraction)
...
- [src/OpenClaw.Gateway/skills/software-developer/contracts/projections/ontology_extraction/memory-session/README.md](src/OpenClaw.Gateway/skills/software-developer/contracts/projections/ontology_extraction/memory-session/README.md)
...
2. 确定首个业务任务域名
3. 选首个交付视图
4. 在 `ontology_extraction` 里落最小 slice
