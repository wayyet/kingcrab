...
如果只想直接使用这套规范，看 [../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/README.md](../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/README.md)。如果想理解它为什么长成现在这样、各个文档之间为什么这么分工、以及这次会话真正完成了什么，这篇文章更合适。
...
- `src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/scripts/validate-slice.py`：技能根目录内真实校验器，本地校验与 review 辅助入口
...
- `src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/scripts/validate-projection.py`：技能根目录内真实 projection 校验器
...
于是有了统一后的 [../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/REVIEW_CHECKLIST.md](../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/REVIEW_CHECKLIST.md)。
...
因此，规范包后续又补了一份 [../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/DECISION_GUIDE.md](../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/DECISION_GUIDE.md)。
...
所以这次会话后期又专门把迁移规则独立成了 [../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/SCHEMA_MIGRATION.md](../src/OpenClaw.Plugins.EmploymentCoachWorkflow/skills/ontology_extraction/references/SCHEMA_MIGRATION.md)。
